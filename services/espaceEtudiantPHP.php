<?php require('headerServices.php');?>
 ...
 <!-- SHOWCASE start  -->
 <section class="showcase-php">
        <div class="w3-container w3-center">
            <h1 class="w3-text-shadow w3-animate-opacity php">Maitriser PHP</h1>
            <hr>
    ...
    <div class="w3-card-8 w3-dark-grey">
        <div class="w3-container w3-center">
            <h3>PHP Les Bases</h3>
            <img class="card-img w3-hover-opacity" src="images/php-tutorials-basics.png" alt="PHP-basics">
            <h5>PHP</h5>
    ...
    <div class="w3-card-8 w3-dark-grey">
        <div class="w3-container w3-center">
            <h3>PHP Les Bases</h3>
            <img class="card-img" src="images/laravel-training.jpg" alt="PHP-basics">
            <h5>PHP</h5>
    ...
    <div class="w3-card-8 w3-dark-grey">
        <div class="w3-container w3-center">
            <h3>PHP Les Bases</h3>
            <img class="card-img" src="images/Symfony-5-The-complete-Guide-for-Beginners.jpg" alt="PHP-basics">
            <h5>PHP</h5>
