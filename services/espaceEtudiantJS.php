<?php require('headerServices.php');?>

 <!-- SHOWCASE start  -->
 <section class="showcase-js">
        <div class="w3-container w3-center">
            <h1 class="w3-text-shadow w3-animate-opacity js">Maitriser JavaScript</h1>
            <hr>
    ...
    <div class="w3-card-8 w3-dark-grey">
        <div class="w3-container w3-center">
            <h3>C'est quoi Nodejs?</h3>
            <img class="card-img w3-hover-opacity w3-round" src="images/nodejs.jpg" alt="PHP-basics">
            <h5>JavaScript</h5>

            <button class="w3-btn w3-green">Commencer</button>
            <button class="w3-btn w3-red">Sauvegarder</button>
        </div>
    </div>
    </div>
    ...
    <div class="w3-card-8 w3-dark-grey">
        <div class="w3-container w3-center">
            ...
            <img class="card-img w3-round" src="images/mean-stack-banner.jpg" alt="PHP-basics">
            <h5>JavaScript</h5>
    ...
    <div class="w3-card-8 w3-dark-grey">
        <div class="w3-container w3-center">
            <h3>Bibliothèque jQuery</h3>
            <img class="card-img w3-round" src="images/jquery-detect-scroll-up-scroll-down.jpg" alt="PHP-basics">
            <h5>JavaScript</h5>
